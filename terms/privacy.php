...
?>
    <section class="row">
        ...
        <section class="col-md-8 lead my-5 p-4">
            <h2 class="text-center">Privacy Policy for Poa Price Uganda</h2>
            <hr>
            <p>At Poa Price Uganda, accessible from https://www.poapriceuganda.com, one of our main priorities is the privacy of
                our
                visitors. This Privacy Policy document contains types of information that is collected and recorded
                by
                Poa Price Uganda and how we use it.</p>
            <p>If you have additional questions or require more information about our Privacy Policy, do not
                hesitate to
                contact us.</p>
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                with
                regards to the information that they shared and/or collect in Poa Price Uganda. This policy is not
                applicable
            ...
            <h2>Log Files</h2>
            <p>Poa Price Uganda follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <p>Like any other website, Poa Price Uganda uses 'cookies'. These cookies are used to store information
                including
            ...
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                are
                used in their respective advertisements and links that appear on Poa Price Uganda, which are sent
                directly to
            ...
            <p>Note that Poa Price Uganda has no access to or control over these cookies that are used by third-party
                advertisers.</p>
            <h2>Third Party Privacy Policies</h2>
            <p>Poa Price Uganda's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                you
            ...
            <p>Another part of our priority is adding protection for children while using the internet. We encourage
                ...
                activity.</p>
            <p>Poa Price Uganda does not knowingly collect any Personal Identifiable Information from children under the
                age
