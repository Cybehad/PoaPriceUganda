...
<section class="row">
    ...
    <section class="col-md-8 my-5 lead p-4">
        <h2 class="text-center"><strong>Terms and Conditions</strong></h2>
        <hr>
        <p>Welcome to Poa Price Uganda!</p>
        <p>These terms and conditions outline the rules and regulations for the use of Poa Price Uganda's Website,
            located at https://www.poapriceuganda.com.</p>
        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Poa Price Uganda
        ...
        <p>We employ the use of cookies. By accessing Poa Price Uganda, you agreed to use cookies in agreement with the
            Poa Price Uganda's Privacy Policy.</p>
        ...
        <p>Unless otherwise stated, Poa Price Uganda and/or its licensors own the intellectual property rights for
            all
            material on Poa Price Uganda. All intellectual property rights are reserved. You may access this from Poa Price Uganda
            for
            your own personal use subjected to restrictions set in these terms and conditions.</p>
        <p>You must not:</p>
        <ul>
            <li>Republish material from Poa Price Uganda</li>
            <li>Sell, rent or sub-license material from Poa Price Uganda</li>
            <li>Reproduce, duplicate or copy material from Poa Price Uganda</li>
            <li>Redistribute content from Poa Price Uganda</li>
        </ul>
        <p>This Agreement shall begin on the date hereof.</p>
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain areas of the website. Poa Price Uganda does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and opinions of Poa Price Uganda,its
            agents
            and/or affiliates. Comments reflect the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, Poa Price Uganda shall not be liable for the
            Comments
        ...
        <p>Poa Price Uganda reserves the right to monitor all Comments and to remove any Comments which can be
            considered
        ...
        <p>You hereby grant Poa Price Uganda a non-exclusive license to use, reproduce, edit and authorize others to
            use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
            ...
            absence of Poa Price Uganda; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
            website, you must inform us by sending an e-mail to Poa Price Uganda. Please include your name, your
        ...
        <p>No use of Poa Price Uganda's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
