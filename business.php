            ...
            <aside class="bd-aside sticky-xl-top text-muted align-self-start mb-3 mb-xl-5 px-2">
                ...
                <nav class="small" id="toc">
                    <ul class="list-unstyled">
                        <li class="my-2">
                            <button class="btn d-inline-flex align-items-center collapsed" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#contents-collapse" aria-controls="contents-collapse">Phones & Accessories</button>
                            <ul class="list-unstyled ps-3 collapse" id="contents-collapse">
                                <li><a class="d-inline-flex align-items-center rounded" href="#typography">Only Mobile Phones</a></li>
                                <hr class="m-0 p-0">
                                <li><a class="d-inline-flex align-items-center rounded" href="#typography">Samsung Galaxy</a></li>
                                <li><a class="d-inline-flex align-items-center rounded" href="#images">Apple iPhone</a></li>
                                <li><a class="d-inline-flex align-items-center rounded" href="#figures">Huawei</a></li>
                                <li><a class="d-inline-flex align-items-center rounded" href="#tables">Tecno & Infinix</a></li>
                                <li><a class="d-inline-flex align-items-center rounded" href="#tables">Accessories</a></li>
                        ...
                        <li class="my-2">
                            <button class="btn d-inline-flex align-items-center collapsed" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#forms-collapse" aria-controls="forms-collapse">Computer &amp; Laptop</button>
                            <ul class="list-unstyled ps-3 collapse" id="forms-collapse">
                                <li><a class="d-inline-flex align-items-center rounded" href="#overview">Only Computer &amp; Laptop</a></li>
                                <hr class="m-0 p-0">
                                <li><a class="d-inline-flex align-items-center rounded" href="#overview">Apple</a></li>
                                <li><a class="d-inline-flex align-items-center rounded" href="#disabled-forms">Dell</a></li>
                                <li><a class="d-inline-flex align-items-center rounded" href="#disabled-forms">Hp</a></li>
                                <li><a class="d-inline-flex align-items-center rounded" href="#sizing">Samsung</a></li>
                                <li><a class="d-inline-flex align-items-center rounded" href="#input-group">Accer</a></li>
                                <li><a class="d-inline-flex align-items-center rounded" href="#input-group">Others</a></li>
                            </ul>
                        </li>
                        <li class="my-2">
