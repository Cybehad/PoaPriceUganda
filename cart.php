...
?>
    <main role="main" class="row">
        <div class="shadow-sm mb-2 mt-4">
            <h1 class="text-body text-center text-decoration-underline">Cart | iPhone 6 Plus.</h1>
            <hr>
        </div>
        ...
        <div class="col-md-9">
            <div class="album py-2 bg-light">
                <div class="row px-2">
                    <h3 class="text-center">iPhone 6 | Check Now</h3>
                    <hr>
                        <div class="py-2 text-center">
                            <img class="d-block mx-auto rounded-circle" src="assets/img/favicon/ppu-icon.png" alt="" width="72" height="72">
                        </div>
                        <div class="row mt-3">
